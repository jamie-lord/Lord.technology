...
tags:
  - anthropic
---
In a [new paper](https://transformer-circuits.pub/2024/scaling-monosemanticity/index.html), researchers at Anthropic have made significant strides in understanding the inner workings of large language models like Claude 3 Sonnet. By applying a technique called sparse dictionary learning, they were able to extract millions of interpretable "features" that shed light on how these AI systems represent knowledge and perform computations.

The implications matter. For the first time, we are getting a glimpse under the hood of cutting-edge AI, revealing an intricate web of concepts, abstractions, and associations. The Anthropic team discovered features corresponding to everything from famous individuals to cities and countries to elements of computer code. Many features were multilingual, multimodal (spanning text and images), and able to generalise between concrete and abstract ideas.

The most striking, and perhaps unsettling, findings relate to what the researchers call "safety-relevant features". These are internal representations that connect to potential ways advanced AI systems could cause harm - such as features linked to generating malicious code, expressing bias, engaging in deception, or producing dangerous content. The mere existence of such features doesn't necessarily mean the model will act harmfully, but it highlights the critical importance of understanding and probing the latent knowledge of these increasingly capable systems.
...
Despite the long road ahead, this work brings us meaningfully closer to capable AI systems with greater transparency, control and robustness. As the researchers conclude: "In the long run, we hope that having access to features like these can be helpful for analyzing and ensuring the safety of models." The road to safe and beneficial AI likely runs through the dense circuits of the networks themselves, and this paper is a real step along it.