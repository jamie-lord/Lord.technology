...
![JHACK homepage]({{ site.url }}/assets/img/jhack-home.jpg){: width="880" height="1219" loading="lazy" decoding="async" }
...
![JHACK post page]({{ site.url }}/assets/img/jhack-post.png){: width="880" height="774" loading="lazy" decoding="async" }
...
![JHACK gtmetrix score card]({{ site.url }}/assets/img/jhack-gtmetrix.jpg){: width="710" height="265" loading="lazy" decoding="async" }
