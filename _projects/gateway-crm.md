...
![Gateway CRM add new page]({{ site.url }}/assets/img/gateway-crm-add-new.png){: width="838" height="583" loading="lazy" decoding="async" }
...
![Gateway CRM search function]({{ site.url }}/assets/img/gateway-crm-search.png){: width="838" height="583" loading="lazy" decoding="async" }
